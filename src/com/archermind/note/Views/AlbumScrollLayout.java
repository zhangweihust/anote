...
public class AlbumScrollLayout extends ViewGroup {
	...
	public AlbumScrollLayout(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
		// TODO Auto-generated constructor stub
	}

	public AlbumScrollLayout(Context context, AttributeSet attrs, int defStyle) {
	...
	public boolean onTouchEvent(MotionEvent event) {
		...
		case MotionEvent.ACTION_UP:
			...
			NoteApplication.LogD(AlbumScrollLayout.class, "velocityX:" + velocityX);
			if (velocityX > SNAP_VELOCITY && mCurScreen > 0) {
				...
				NoteApplication.LogD(AlbumScrollLayout.class, " snap left mCurScreen=" + (mCurScreen - 1));
				...
				NoteApplication.LogD(AlbumScrollLayout.class, " snap right mCurScreen=" + (mCurScreen - 1));
				snapToScreen(mCurScreen + 1);
			} else {
				snapToDestination();
			}
